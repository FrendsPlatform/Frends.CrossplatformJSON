...
using Frends.JSON.EnforceTypes.Helpers;
...
{
    /// <summary>
    /// Frends Task for enforcing types in JSON documents.
    /// </summary>
    public static class JSON
    {
        ...
        /// <returns>Result object { bool Success, Error Error, string JsonAsString }</returns>
        public static Result EnforceTypes([PropertyTab] Input input, [PropertyTab] Options options, CancellationToken cancellationToken)
        {
            try
            {
